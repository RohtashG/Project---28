...
var boy, boyimg;
var stones;
var mango1, mango2, mango3, mango4, mango4, mango6, mango7, mango8, mango9, mango10;

function preload(){
	treeImg = loadImage("sprites/tree.png");
	bodyImg = loadImage("sprites/boy.png");
}
...
function detectCollision(lstones,lmango){
	...
	if(lstones.body.position.x - lmango.body.position.x <lmango.diametre + lstones.diametre
		...
		&&lstones.body.position.y -llmango.body.position.y < lmango.diametre + lstones.diametre
